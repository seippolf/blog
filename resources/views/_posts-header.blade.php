            ...
            <div x-data="{ show : false}" @click.away="show = false">
                ...
                <svg class="transform -rotate-90 absolute pointer-events-none" style="right: 12px;" width="22"
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <path stroke="#000" stroke-ozpacity=".012" stroke-width=".5" d="M21 1v20.16H.84V1z">
                        </path>
                        <path fill="#222"
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 w-full mt-2 rounded-xl z-50" style="display: none">
                    <a href="/" class="block text-left px-3 text-sm leading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white">
                        All
                    </a>
